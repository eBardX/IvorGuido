...
extension GMNParseFunctionsTests {
    @Test
    func test_convertString_failure() {
    ...
    @Test
    func test_convertString_success() {
    ...
    @Test
    func test_parseTablature_failure() {
        #expect(parseTablature("") == nil)
    }

    @Test
    func test_parseTablature_success() {
    ...
    @Test
    func test_splitTagNameIdent() {
        #expect(splitTagNameIdent("\\slurBegin") == ("\\slurBegin", nil))
        #expect(splitTagNameIdent("\\slurEnd:1") == ("\\slurEnd", 1))
        #expect(splitTagNameIdent("\\tieBegin:2") == ("\\tieBegin", 2))
        #expect(splitTagNameIdent("\\tieEnd:3") == ("\\tieEnd", 3))
    }
}
